...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('adto_campaign', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('adto', ['Campaign'])

        # Adding model 'Banner'
        db.create_table('adto_banner', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adto.Campaign'])),
        ...
        db.send_create_signal('adto', ['Banner'])


    def backwards(self, orm):
        
        # Deleting model 'Campaign'
        db.delete_table('adto_campaign')

        # Deleting model 'Banner'
        db.delete_table('adto_banner')
