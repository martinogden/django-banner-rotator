...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('banner_rotator_banner', 'clicks', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Banner.clicks'
        db.delete_column('banner_rotator_banner', 'clicks')
